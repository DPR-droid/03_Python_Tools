...
def search_qradar(start_date, end_date):
...
# Example usage: search for records between January 1, 2020 and January 31, 2020
records = search_qradar('2020-01-01', '2020-01-31')
print(records)
